/***************************************************************
 ...
 Flix Kernel is free software; you can redistribute it and/or modify it under the
 terms of the GNU General Public License as published by the Free Software
 Foundation; either version 2, or (at your option) any later version.

 Flix Kernel is distributed in the hope that it will be useful, but WITHOUT ANY
 WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS
 FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more
 details.

 You should have received a copy of the GNU General Public License along with
 Flix Kernel; see the file COPYING.  If not, write to the Free Software Foundation,
...
#define ZDCONFIG              /* include support to configure Flix kernel */
/* #define DRSYS */           /* SYS for Enhanced DR-DOS (OpenDOS enhancement Project) */

#define SYS_VERSION "v6.22"
#define SYS_NAME "ZanvokDOS System Installer "
...
/* ZanvokDOS sys, we default to our kernel and load segment, but
   if not found (or explicitly given) support OEM DOS variants
   (such as DR-DOS or a ZanvokDOS kernel mimicing other DOSes).
...
#ifndef DRSYS
#define OEM_FD     0  /* standard ZanvokDOS mode */
#define OEM_EDR    1  /* use ZanvokDOS boot sector, but OEM names */
#define OEM_DR     2  /* FD boot sector,(Enhanced) DR-DOS names */
#else
#define OEM_FD     2  /* standard ZanvokDOS mode */
#define OEM_EDR    0  /* use ZanvokDOS boot sector, but OEM names */
...
CONST char * msgDOS[DOSFLAVORS] = {  /* order should match above items */
  "\n",  /* In standard ZanvokDOS/EnhancedDR mode, don't print anything special */
#ifndef DRSYS
  "Enhanced DR DOS (OpenDOS Enhancement Project) mode\n",
#endif
  "DR DOS (OpenDOS Enhancement Project) mode\n",
#ifdef DRSYS
  "\n",  /* ZanvokDOS mode so don't print anything special */
#endif
#ifdef WITHOEMCOMPATBS
...
void showHelpAndExit(void)
{
  printf(
      ...
      "             /OEM:FD use ZanvokDOS compatible settings\n"
...
void initOptions(int argc, char *argv[], SYSOptions *opts)
{
  ...
  */
  ...
  /* if unable to determine DOS, assume ZanvokDOS */
...
void put_boot(SYSOptions *opts)
{
  ...
  /* originally OemName was "ZanvokDOS", changed for better compatibility */
