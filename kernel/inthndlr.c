    ...
    case 0x33:
     ...
     /* case 0x07: */          /* neither here */
        ...
        case 0xfc:
          ...
          /* Toggle Flix Kernel rdwrblock trace dump                    */
#ifdef DEBUG
        case 0xfd:
          ...
          /* Toggle Flix Kernel syscall trace dump                      */
#ifdef DEBUG
        case 0xfe:
          bDumpRegs = !bDumpRegs;
          break;
          ...
          /* Get Flix Kernel release string pointer                     */
        case 0xff:
#if !defined __GNUC__ || defined  __IA16_FEATURE_ATTRIBUTE_NO_ASSUME_SS_DATA
