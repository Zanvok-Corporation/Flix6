...
; File:
;                            OEM Boot
;                      2022, Zanvok Corporation
;                Copyright (c) 200?, <add name here>
; Description:
; OEM boot sector for ZanvokDOS compatible with IBM's (R) PC-DOS,
; and Microsoft's (R) MS-DOS.  It may work with older OpenDOS/DR-DOS,
; although the standard ZanvokDOS boot sector is needed with ver 7+
...
; use it to boot the ZanvokDOS kernel as it expects to be
...
;                      All Rights Reserved
;
; This file is part of ZanvokDOS.
;
